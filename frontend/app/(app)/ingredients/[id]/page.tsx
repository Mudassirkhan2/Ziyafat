  ...
  useEffect(() => {
    if (ingredient) {
      form.reset({
        ...
        stock_on_hand: String(ingredient.stock_on_hand ?? 0),
        reorder_threshold: String(ingredient.reorder_threshold ?? 0),
        category: ingredient.category ?? "",
        yield_percentage: String(ingredient.yield_percentage ?? 100),
        purchase_unit: ingredient.purchase_unit ?? "",
        unit_conversion_factor: ingredient.unit_conversion_factor != null
          ? String(ingredient.unit_conversion_factor)
          : "",
        allergen_flag: ingredient.allergen_flag ?? false,
        waste_percentage: String(ingredient.waste_percentage ?? 0),
        storage_location: ingredient.storage_location ?? "",
        shelf_life_days: ingredient.shelf_life_days != null ? String(ingredient.shelf_life_days) : "",
