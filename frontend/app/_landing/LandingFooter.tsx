      ...
      <div className={s.wrap}>
        <div className={s.foot}>
          ...
          <div className={s.fCol}>
            <h4>Platform</h4>
            <a href="/#modules">Leads &amp; Inquiries</a>
            <a href="/#modules">Bookings &amp; Events</a>
            <a href="/#modules">Quotations</a>
            <a href="/#modules">Invoices &amp; PDF</a>
            <a href="/#modules">Public Storefront</a>
          </div>
          <div className={s.fCol}>
            <h4>Company</h4>
          ...
          <div className={s.fCol}>
            <h4>Resources</h4>
            <a href="/blog/best-free-catering-software-india-2025">Free software guide</a>
            <a href="/blog/best-catering-management-app-small-business">Small business guide</a>
            <a href="/blog/best-catering-software-hyderabad">Hyderabad caterers</a>
        ...
        <div className={s.footBottom}>
          ...
          <div className={s.footSoc}>
            <a href="https://x.com/Mudassir_222" target="_blank" rel="noopener noreferrer" aria-label="X">
            ...
            <a href="https://www.linkedin.com/in/mudassirkhanmohammed" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            ...
            <a href="https://www.instagram.com/mudassir_222001/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
