  ...
  async function onSubmit(values: SignupValues) {
    try {
      await api.post("/setup", {
        ...
        org_phone: null, org_email: null, org_address: null, org_tagline: null,
        ...
        <div className={styles.brandMiddle}>
          ...
          <div className={styles.svgWrap}>
            <svg viewBox="0 0 460 320" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "100%", maxWidth: 460, display: "block", overflow: "visible" }}>
              <defs>
                <linearGradient id="sg-teal" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#0e6e6e" /><stop offset="1" stopColor="#072e2e" /></linearGradient>
                <linearGradient id="sg-gold" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stopColor="#e6cf9c" /><stop offset="1" stopColor="#caa463" /></linearGradient>
                <linearGradient id="sg-glass" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="#ffffff" stopOpacity=".12" /><stop offset="1" stopColor="#ffffff" stopOpacity=".03" /></linearGradient>
              </defs>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            <div className={styles.fieldGroup}>
              <AuthField
                ...
                inputProps={{ type: "text", placeholder: "e.g. Al-Noor Caterers", ...register("org_name") }}
              />
              ...
              <AuthField
                ...
                inputProps={{ type: "text", placeholder: "Mudassir Khan", autoComplete: "name", ...register("owner_name") }}
              />
              <AuthField
                id="su-email"
                label="Email"
                ...
                inputProps={{ type: "email", placeholder: "you@example.com", autoComplete: "email", ...register("owner_email") }}
              />
              <AuthField
                id="su-password"
                label="Password"
                ...
                inputProps={{ placeholder: "Min 8 characters", autoComplete: "new-password", ...register("owner_password") }}
              />
              <AuthField
                id="su-confirm"
                ...
                icon={<LockIcon />}
                showToggle
                error={errors.owner_password_confirm?.message}
                inputProps={{ placeholder: "••••••••", autoComplete: "new-password", ...register("owner_password_confirm") }}
              />
            </div>
